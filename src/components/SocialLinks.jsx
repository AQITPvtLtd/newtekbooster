...
const SocialLinks = () => {
  return (
    <div className="hidden sm:flex gap-4 fixed top-0 mt-[200px] right-0 flex-col justify-center items-center p-4 bg-gray-200 z-40 rounded-l-xl">
      ...
      <div className="group relative w-max">
        <Link
          href="https://www.instagram.com/tek_booster/"
          role="button"
          target="__blank"
        >
      ...
      {/* whatsapp */}
      <div className="group relative w-max">
        <Link target="__blank" href="https://wa.link/1dzd8t" role="button">
      ...
      <div className="group relative w-max">
        <Link
          href="https://in.pinterest.com/tekbooster/"
          role="button"
          target="__blank"
        >
      ...
      <div className="group relative w-max">
        <Link
          href="https://twitter.com/Tek_booster"
          role="button"
          target="__blank"
        >
      ...
      <div className="group relative w-max">
        <Link
          href="https://www.quora.com/profile/Tekbooster"
          role="button"
          target="__blank"
        >
          <svg
